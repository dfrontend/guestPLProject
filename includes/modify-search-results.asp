		...
		<div class="row">
			<div class="search-module clearfix">
					<form class="form-inline">
						...
						<div class="wrap-1 form-group pos-relative">
						...
						<div class="wrap-2 form-group pos-relative">
						...
						<div class="wrap-4 form-group col-lg-2 col-md-2 col-sm-1 col-xs-12 pull-right">
