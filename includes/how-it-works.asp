				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4">
						<div class="box">
							...
							<p>Lorem ipsum dolor sit amet to consectetur adipiscing elit</p>
						</div>	
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4">
						<div class="box">
							<div class="bg-plate">
								<i class="icon-gp-bow-tie"></i>
							</div>
							<h2 class="title">Select your host</h2>
							<p>Lorem ipsum dolor sit amet to consectetur adipiscing elit</p>
						</div>	
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4">
						<div class="box">
							...
							<h2 class="title">Submit your order</h2>
							<p>Lorem ipsum dolor sit amet to consectetur adipiscing elit</p>
						</div>	
					</div>
				</div>
